...
var obj;
function loadJSON(str,override,anim) {
    ...
    if (anim) {
      //Animate tile load
      var count = tiles.length - anim;
      Array.prototype.forEach.call(tiles, function(e,i) {        
        if (i < count) { return; }
